...
| step      | int    | Record the training steps. The data will be sampled, meaning that only part of data will be displayed. (the sampling algorithm is reservoir sampling, details can be refered to [VisualDL sampling algorithm](../faq_EN.md/#what-are-the-sampling-rules-of-visualdl))                                      |
