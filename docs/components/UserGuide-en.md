...
| step      | int    | Record the training steps. The data corresponding to several steps will be extracted for display (the sampling algorithm used by VisualDL is reservoir sampling, please refer to [VisualDL sampling algorithm](../faq_EN.md/#what-are-the-sampling-rules-of-visualdl)                                    |
