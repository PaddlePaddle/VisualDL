...
class Api(object):
    ...
    def scalars_tags(self):
        return self._get_with_retry('data/plugin/multiscalars/tags', lib.get_scalars_tags)
    ...
    def scalars_list(self, run, tag, sub_tag):
        key = os.path.join('data/plugin/multiscalars/scalars', run, tag, sub_tag)
    ...
    def scalars_data(self, run, tag, sub_tag, type='tsv'):
        key = os.path.join('data/plugin/multiscalars/data', run, tag, sub_tag, type)
