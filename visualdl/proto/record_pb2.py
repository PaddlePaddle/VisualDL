...
_RECORD_VALUE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tag_value', full_name='visualdl.Record.Value.tag_value', index=13,
...
_RECORD = _descriptor.Descriptor(
  ...
  nested_types=[_RECORD_IMAGE, _RECORD_TEXT, _RECORD_AUDIO, _RECORD_EMBEDDING, _RECORD_EMBEDDINGS, _RECORD_BYTES_EMBEDDINGS, _RECORD_HISTOGRAM, _RECORD_PRCURVE, _RECORD_ROC_CURVE, _RECORD_HPARAM, _RECORD_METADATA, _RECORD_TAGVALUE, _RECORD_VALUE, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
