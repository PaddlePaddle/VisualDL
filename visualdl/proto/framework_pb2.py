...
VarType = _reflection.GeneratedProtocolMessageType('VarType', (_message.Message,), {
  'TensorDesc' : _reflection.GeneratedProtocolMessageType('TensorDesc', (_message.Message,), {
    'DESCRIPTOR' : _VARTYPE_TENSORDESC,
    '__module__' : 'framework_pb2'
    # @@protoc_insertion_point(class_scope:paddle.framework.proto.VarType.TensorDesc)
    })
  ,
  'LoDTensorDesc' : _reflection.GeneratedProtocolMessageType('LoDTensorDesc', (_message.Message,), {
    'DESCRIPTOR' : _VARTYPE_LODTENSORDESC,
    '__module__' : 'framework_pb2'
    # @@protoc_insertion_point(class_scope:paddle.framework.proto.VarType.LoDTensorDesc)
    })
  ,
  'LoDTensorArrayDesc' : _reflection.GeneratedProtocolMessageType('LoDTensorArrayDesc', (_message.Message,), {
  ...
  ,
  'ReaderDesc' : _reflection.GeneratedProtocolMessageType('ReaderDesc', (_message.Message,), {
...
VarDesc = _reflection.GeneratedProtocolMessageType('VarDesc', (_message.Message,), {
  'DESCRIPTOR' : _VARDESC,
  '__module__' : 'framework_pb2'
  # @@protoc_insertion_point(class_scope:paddle.framework.proto.VarDesc)
  })
_sym_db.RegisterMessage(VarDesc)
BlockDesc = _reflection.GeneratedProtocolMessageType('BlockDesc', (_message.Message,), {
...
ProgramDesc = _reflection.GeneratedProtocolMessageType('ProgramDesc', (_message.Message,), {
