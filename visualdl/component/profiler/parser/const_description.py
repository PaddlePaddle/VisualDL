...
TOOLTIP_MODEL_PERSPECTIVE_CN = \
  ...
  '&nbsp;&nbsp;<b class="bold">DataLoader: 表示使用paddle.io.DataLoader从数据集中取数据的阶段<br>'\
  '&nbsp;&nbsp;<b class="bold">Forward: 表示模型前向计算的阶段<br>'\
  '&nbsp;&nbsp;<b class="bold">Backward: 表示模型反向梯度计算的阶段<br>'\
  '&nbsp;&nbsp;<b class="bold">Optimization: 表示模型优化更新参数的阶段<br>'\
  '&nbsp;&nbsp;<b class="bold">Other: 其它时间<br>'

TOOLTIP_MODEL_PERSPECTIVE_PERSTEP_CN = \
  '<div>展示每一个ProfileStep内模型各阶段DataLoader, Forward, Backward, Optimization以及Other的CPU和GPU时间。<br>'\
  '<div>CPU时间即是各阶段代码执行的时间，GPU时间是各阶段所调用的GPU Kernel在GPU上的计算时间。<br>'\
  '&nbsp;&nbsp;<b class="bold">DataLoader: 表示使用paddle.io.DataLoader从数据集中取数据的阶段<br>'\
  '&nbsp;&nbsp;<b class="bold">Forward: 表示模型前向计算的阶段<br>'\
  '&nbsp;&nbsp;<b class="bold">Backward: 表示模型反向梯度计算的阶段<br>'\
  '&nbsp;&nbsp;<b class="bold">Optimization: 表示模型优化更新参数的阶段<br>'\
...
TOOLTIP_DEVICE_INFO_EN = \
  ...
  '<b class="bold">Est. Achieved Occupancy</b>'\
  ...
  '<b class="bold">Tensor cores ratio</b>'\
