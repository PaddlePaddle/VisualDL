...
VisualDL in PyTourch. Embedding visualization is useful to verify the training algorithm does
group the words with similar semantics together. The close two words are,
the more sematic meaning they share.
